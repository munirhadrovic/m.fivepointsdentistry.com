...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <title>Five Points Dentistry</title>
    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            ...
            <li><span>Image 03</span><div><h3>Five Points</h3></div></li>
            <li><span>Image 04</span><div><h3>Dentistry</h3></div></li>
            <li><span>Image 05</span><div><h3>Five Points</h3></div></li>
            <li><span>Image 06</span><div><h3>Dentistry</h3></div></li>
        </ul>
        <div class="container">
            <!-- Codrops top bar -->
           <!--  <div class="codrops-top">
            ...
            <header>
                <h1> <span>Five Points Dentistry</span></h1>
